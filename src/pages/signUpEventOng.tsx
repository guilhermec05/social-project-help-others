...
export function SignUpEventOng(){
    ...
    <Flex  
     ...
     >
        ...
        >
            <Flex maxW={'500px'}>
                <Text fontSize={'h4'}>Cadastro de Evento para ONG</Text>
            </Flex>
            <Flex 
                flexDirection={'column'}
                gap={5}
            ...
            <Flex maxW={'500px'} w={'100%'} flexDirection={'column'}>
                <Text fontSize={'p'} color={'dark_light'}>Inicio:</Text>   
                <InputMain
                    name="inicio"
                    useControl={control}
                    ...
                    type="datetime-local"
                />
                <Text fontSize={'p'} color={'dark_light'} mt={'20px'}>Final:</Text>   
                <InputMain
                    name="final"
                    useControl={control}
                    placeholder="Select Date and Time"
